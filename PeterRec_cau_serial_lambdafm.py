...
import data_loader_recsys_transfer_finetune_lambdafm as data_loader_recsys
import generator_peterrec_cau_serial as generator_recsys
import utils
import shutil
import time
import math
...
def main():
    ...
    dl = data_loader_recsys.Data_Loader({'model_type': 'generator', 'dir_name': args.datapath, 'lambdafm_rho': args.rho})
